...
PRODUCTS_URL = "https://apitotvsmoda.bhan.com.br/api/totvsmoda/analytics/v2/product-fiscal-movement/search"
headers = {
...
while True:
    ...
    resp = requests.post(PRODUCTS_URL, headers=headers, json=payload)
