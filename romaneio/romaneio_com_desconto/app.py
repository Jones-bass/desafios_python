...
# === Caminhos ===
caminho_excel = r"D:\Search\desafios_python\romaneio\romaneio_simples\produtos.xlsx"
...
caminho_pdf_saida = r"D:\Search\desafios_python\romaneio\romaneio_simples\lista_produtos.pdf"
...
titulo = Paragraph("<b>Bazar Rapha Mendonça</b>", titulo_style)
...
for _, linha in df.iterrows():
    ...
    for col in colunas_exibir:
        if col == "Imagem":
            ...
            try:
                # Verificar se o valor é numérico e formatar como porcentagem
                desconto = float(linha[col])
                desconto_formatado = f"{desconto*100:.2f}%"  # Multiplica por 100 para converter em porcentagem
            except:
                desconto_formatado = "0.00%"  # Se não for numérico, coloca 0%
            linha_dados.append(Paragraph(desconto_formatado, wrap_style))
...
# === Monta tabela ===
larguras_colunas = [ 30, 50, 45, 118, 40, 50, 40, 40, 50, 50, 55 ]
